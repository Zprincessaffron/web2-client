...
const ArabianCuisine = () => {
  ...
  return (
    <div className="bg-purple-100 min-h-screen p-8">
      <h1 className="text-4xl font-extrabold text-center mb-8 text-purple-600">Arabian Cuisine Recipes</h1>
            ...
            >
              ...
              {expandedRecipeIndex === index && (
                ...
                >
                  ...
                  {recipe.variations_and_additions?.length > 0 && (
                    <>
                      <h3 className="text-xl font-semibold mt-4">Variations:</h3>
                      <ul className="list-disc pl-5 mb-4">
                        {recipe.variations_and_additions.map((variation, i) => (
                  ...
                  {recipe.storage?.length > 0 && (
                    <>
                      <h3 className="text-xl font-semibold mt-4">Storage:</h3>
                      <ul className="list-disc pl-5 mb-4">
                        {recipe.storage.map((tip, i) => (
                          <li key={i} className="mb-2">{tip}</li>
                        ))}
                      </ul>
                    </>
