...
const JapaneseCuisine = () => {
  ...
  const Modal = ({ isOpen, onClose, message }) => {
    ...
    return (
      ...
      <div className="bg-custom-gradient-5 p-8 rounded-lg shadow-lg md:w-full w-[90%] max-w-lg relative">
      <button
          onClick={onClose}
  ...
  return (
    <div className="bg-custom-gradient-5 min-h-screen p-10">
      ...
      {selectedRecipe && (
        ...
        >
          <motion.div
            className="bg-custom-gradient-5 p-10 rounded-lg shadow-2xl max-w-3xl w-full max-h-screen relative overflow-hidden "
