...
const JapaneseCuisine = () => {
  ...
  return (
    <div className="bg-green-100 min-h-screen p-8">
      <h1 className="text-4xl font-extrabold text-center mb-8 text-green-600">Japanese Cuisine Recipes</h1>
                          ...
                          <motion.div key={section} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }}>
                            ...
                            <ul className="list-disc pl-5">
                              {Array.isArray(items) ? (
                                ...
                                <motion.li className="mb-2" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }}>
                                  Unexpected data format: {JSON.stringify(items)}
                                </motion.li>
                              )}
                            </ul>
                          </motion.div>
