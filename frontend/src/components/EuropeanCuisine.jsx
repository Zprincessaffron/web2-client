...
const EuropeanCuisine = () => {
  ...
  const Modal = ({ isOpen, onClose, message }) => {
    ...
    return (
      ...
      <div className="bg-custom-gradient-4 p-8 rounded-lg shadow-lg md:w-full w-[90%] max-w-lg relative">
      <button
          onClick={onClose}
  ...
  return (
    <div className="bg-custom-gradient-4 min-h-screen p-10">
      ...
      {selectedRecipe && (
        ...
        >
          <motion.div
            className="bg-custom-gradient-4 p-10 rounded-lg shadow-2xl max-w-3xl w-full max-h-screen relative overflow-y-auto scrollbar-custom"
          ...
          >
            <button
              ...
              onClick={() => toggleRecipeDetails(selectedRecipe)}
            >
            ...
            <div className="max-h-[70vh] overflow-y-auto p-4 text-white scrollbar-custom">
              <h3 className="md:text-2xl text-lg tracking-widest font-medium mb-2">Ingredients :</h3>
